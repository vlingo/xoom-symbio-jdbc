...
import io.vlingo.xoom.symbio.store.object.jdbc.jpa.model.JPADispatchable;
...
public class JPAObjectStoreDelegate implements ObjectStoreDelegate<Entry<String>, State<?>> {
    ...
    /*
     * @see
     * io.vlingo.xoom.symbio.store.object.ObjectStore#registerMapper(io.vlingo.xoom.symbio.
